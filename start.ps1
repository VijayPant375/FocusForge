...
$services = @("api-gateway", "user-service", "habit-service", "analytics-service", "ai-service", "notification-service", "frontend")
...
Write-Host "Note: To shut down the app, simply close the 7 popup terminal windows."
